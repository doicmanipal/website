        ...
        <div key={internship.id}>
          <div className="card card-side bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              ...
              <p>
                <span className="font-bold">Country:</span> {internship.data.country}
              </p>

              <p>
                <span className="font-bold">Description:</span> {internship.data.description}
              </p>
              <p>
                <span className="font-bold">Benefits:</span> {internship.data.benefits}
              </p>
              <p>
                <span className="font-bold">Deadline:</span> {internship.data.deadline}
              </p>
              <p>
                <span className="font-bold">Stipend/Scholarships:</span> {internship.data.money}
              </p>
